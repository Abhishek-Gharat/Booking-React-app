...
const FavoriteBooks = () => {
    ...
    return (
        <div className={`shadow-md ${darkMode ? 'dark:bg-[#12141D] text-white' : 'bg-white'} rounded-3xl overflow-hidden p-5 md:p-9`}>
                            ...
                            <div key={item.id} className="grid grid-cols-[1fr_auto] gap-4">
                                ...
                                <div className="flex justify-between gap-4 items-center">
                                    <button
                                        ...
                                        className={`rounded-md p-2 md:px-4 inline-flex items-center space-x-2 text-white ${darkMode ? 'bg-[#D42967]' : 'bg-[#D42967] hover:bg-[#F95E5A]'}`}
                                    >
                                        <MdDeleteOutline />
